...
create_boxplots <- function(df_standard, target_column_1, target_column_2, output_directory) {
 ...
 df_standard_new <- data.frame(CV_Type = df_standard_name, target_1 = df_standard[[target_column_1]], target_2 = df_standard[[target_column_2]])
...
create_boxplots(df_standard, target_column_1 = "MSE", target_column_2 = "MSEVar",  output_directory = output_path)