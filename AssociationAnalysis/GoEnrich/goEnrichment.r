...
#'
#' Script to run GoEnrichment analysis for each clinical parameter
#' 
...
#' The script then translates the Ensembl gene ids to NCBI gene names and runs GoEnrichment analysis for each clinical 
#' parameter.
#' The script then runs GoEnrichment analysis for each clinical parameter and saves the results as a csv file.
#' 
